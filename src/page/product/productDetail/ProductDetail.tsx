...
export default function ProductDetail() {
  ...
  const initialStateVariant: IVariant[] = product.variants
  const initialStateIngrediants: IIngredient[] = product.ingredients
  ...
  const handleChange = async (value?: string) => {
    ...
    console.log(value)
    console.log(sanitizedHtmlValue)
  }
            ...
            <Stack direction={"row"} spacing={3}>
              ...
              <FormControl sx={{ minWidth: 400 }}>
                ...
                <Select
                  ...
                  id="manufacturer"
                  defaultValue={product.manufacturer.id}
            ...
            {variant.map((_, index) => (
              <Stack key={index} direction="row" spacing={2} sx={{ mb: 6 }}>
                <Controller
                  ...
                  control={control}
                  defaultValue={product.variants[index].id}
                ...
                <Box>
                  <TextField
                    label="Tên"
                    defaultValue={product.variants[index].name}
                    focused
                ...
                <Box>
                  <TextField
                    label="Số lượng"
                    defaultValue={product.variants[index].stock}
                    focused
                ...
                <Box>
                  <TextField
                    label="Kg"
                    defaultValue={product.variants[index].weight}
                    focused
                ...
                <Box>
                  <TextField
                    label="Lít"
                    defaultValue={product.variants[index].liter}
                    focused
                ...
                <Box>
                  <TextField
                    label="Mã"
                    defaultValue={product.variants[index].sku}
                    focused
                ...
                <Box>
                  <FormControl sx={{ minWidth: 210 }}>
                    ...
                    <Select
                      ...
                      id="unit"
                      label="Đơn vị"
                      defaultValue={product.variants[index].unit.id}
              ...
              {ingredients.map((_, index) => (
                <Stack key={index} direction="row" spacing={2} sx={{ mb: 2 }}>
                  <Controller
                    ...
                    control={control}
                    defaultValue={product.ingredients[index].id}
                    render={({ field }) => <input type="hidden" {...field} />}
                  />
                  <Box>
                    <TextField
                      label="Tên"
                      defaultValue={product.ingredients[index].name}
                      focused
                  ...
                  <Box>
                    <TextField
                      label="Thông tin"
                      defaultValue={product.ingredients[index].info}
                      focused
